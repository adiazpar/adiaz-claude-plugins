...
1. **Open** — establish who you honestly are: skills, time, runway, risk tolerance, what you're optimizing for, and what pulls you. For calibration, not for filtering.
2. **Orient** — Claude teaches the four lenses that decide whether a beginner wins, then surveys candidate directions with *live web evidence*, not vibes.
...
├── sessions.jsonl      # one line per session: chosen direction, brief path, next move
