...
Can the founder get a *payable* v0 in front of a customer before they lose momentum (call it ~8 weeks)?

- This is where skills enter — but as a **sizing input, not a gate**. A direction that needs skills the founder lacks isn't disqualified; it just carries a bigger learning gap that the plan must account for.
- Penalize directions that need capabilities taking months to acquire, or that depend on assets the founder can't get (regulatory approval, a hardware supply chain, a large proprietary dataset).
- Reward directions where the founder can **learn by shipping**.

## 3. Money-moves-here — does cash demonstrably change hands?

Is there evidence people *pay* for solutions in this space? Not "would this be cool" — do dollars move?

- **Strong:** incumbents with public pricing, multiple paid alternatives, sold-business comps, people complaining about what they currently *pay for*.
- **Weak:** everyone wants it free, OSS/freebie culture, "I wish" with no willingness-to-pay behind it.
- **The wishlist trap:** "I wish there was a tool for X" is the weakest signal that still feels like demand. Triangulate every wishlist signal against a paying signal before trusting it.
...
- When the user picks a marginally-weaker option because they genuinely care about it, that's often the **right** call — weight it.
