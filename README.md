...
|---|---|---|
| [**cofounder**](./plugins/cofounder/) | A founding meeting between you and Claude — establish who you honestly are, get educated on a landscape with live evidence and dated why-now timing signals, converge on a direction, and leave with an actionable plan and a falsifiable first move. Calibrates to your experience per domain (beginner to pro); earns a detailed execution handoff with Claude Code subagent prompts once a direction is validated. | `/cofounder` |
