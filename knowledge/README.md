...
python tests/re_discipline_project_lane_ablation_archive.py `
  ...
  --output knowledge/evals/conformance/evidence/2026-08-03-snaphak-pre-removal-rerank.zip
...
python tests/re_discipline_project_lane_ablation_build.py `
  ...
  --historical-evidence-archive knowledge/evals/conformance/evidence/2026-08-03-snaphak-pre-removal-rerank.zip `
  --historical-evidence-path evals/conformance/evidence/2026-08-03-snaphak-pre-removal-rerank.zip `
  --production-profile knowledge/profiles/balanced-v1.json `
  --schema knowledge/schemas/project-lane-ablation-report.schema.json `
  ...
  --output knowledge/evals/conformance/project-lane-ablation.json
...
python tests/re_discipline_project_lane_ablation_promote.py `
  --measurement knowledge/evals/conformance/project-lane-ablation.json `
  --project-schema knowledge/schemas/project-lane-ablation-report.schema.json `
  --aggregate-schema knowledge/schemas/lane-ablation-report.schema.json `
  --report knowledge/evals/conformance/lane-ablation-report.json `
  --finding-cases knowledge/evals/conformance/finding-cases.json `
  --decision-output knowledge/evals/conformance/lane-ablation-decision.json
